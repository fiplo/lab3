 ...
 * @author OMEN
 */
public class MapKTUOAv2<K, V> extends MapKTUOA<K, V> implements MapADTx<K, V> {
     ...
     * @param baseObj
     */
    public MapKTUOAv2(K baseKey, V baseObj) {
     ...
     * @param ht
     */
    public MapKTUOAv2(K baseKey, V baseObj, HashType ht) {
     ...
     * @param ht
     */
    public MapKTUOAv2(K baseKey, V baseObj, int initialCapacity, HashType ht) {
     ...
     * @param ht
     */
    public MapKTUOAv2(K baseKey, V baseObj, int initialCapacity, float loadFactor, HashType ht) {
