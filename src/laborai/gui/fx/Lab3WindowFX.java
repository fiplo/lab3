...
public class Lab3WindowFX extends BorderPane implements EventHandler<ActionEvent> {
    ...
    private ZaidejuSukurimas zaidejuTikrinimas = new ZaidejuSukurimas();
    ...
    public void mapGeneration(String filePath) {
        ...
        if (filePath == null) {
            Zaidejas[] autoArray = zaidejuTikrinimas.ZaidejuPridavimas(sizeOfGenSet, sizeOfInitialSubSet);
            for (Zaidejas a : autoArray) {
                map.put(
                        zaidejuTikrinimas.ZaidejaiAnalize(), //raktas
                        a);
            }
    ...
    public void mapAdd() {
        Zaidejas a = zaidejuTikrinimas.SurinktiZaidejai();
        map.put(
                zaidejuTikrinimas.ZaidejaiAnalize(), // Raktas
                a);
        table.formTable(map.getMaxChainSize() * 2 + 1, colWidth);
